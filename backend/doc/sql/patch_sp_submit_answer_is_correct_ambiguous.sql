-- Fix PostgreSQL 42702: is_correct ambiguous in sp_submit_answer combo loop
-- (RETURNS TABLE column shadows game_session_answers.is_correct from question 2 onward)
